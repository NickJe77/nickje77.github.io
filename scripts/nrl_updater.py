...
print("NRL SCRAPER → MATCH FILE BUILDER")

SEASON = 2026
BASE = "https://afltables.com/rl/"
HEADERS = {"User-Agent": "Mozilla/5.0"}

# 🔥 CHANGE THIS TO YOUR REAL REPO PATH
ROOT = Path("/Users/nick/Documents/GitHub/nickje77.github.io")

OUTPUT = ROOT / f"docs/data/nrl/matches/{SEASON}.json"
...
print("Match links found:", len(match_links))

if not match_links:
    print("❌ NO MATCHES FOUND — STOPPING")
    exit()
