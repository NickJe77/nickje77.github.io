#!/usr/bin/env python3
"""
build_bundesliga_data.py

Reads all match JSON files from docs/data/bundesliga/matches/<season>/*.json
and generates three output files:
  - docs/data/bundesliga/players.json
  - docs/data/bundesliga/teams.json
  - docs/data/bundesliga/team-stats.json
...
MATCHES_DIR = REPO_ROOT / "docs" / "data" / "bundesliga" / "matches"
OUT_DIR     = REPO_ROOT / "docs" / "data" / "bundesliga"
